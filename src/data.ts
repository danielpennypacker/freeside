...
},
{
    ...
    dmNotes: "Players can come here to try and exert political influence over Freeside. Whatever's happening in Freeside, should be mirrored here, but in a silly way.",
...
"When the queen arrives, she'll she the players are new. She'll ask them whether or not she should invade the country and set up a new base."],
    randomNpcs: [
        ...
        },        
        {
            name: "The Queen",
            race: "human",
            job: "The current Queen of the fools court.",
            description: "A cartoon version of a queen with heavy makeup.",
            dialogue: "Court is in session! Silence!",
        },        
        {
            name: "Flipflab",
            race: "saytr",
...
},
{
    ...
    dmNotes: "This is like the main hub of the Water District.",
